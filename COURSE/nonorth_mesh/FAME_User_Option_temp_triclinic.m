...
SC_lattice_constant_a = 1; n_supercell = 1;
Popt.lattice.lattice_vec_a = [ 0.5*SC_lattice_constant_a*[-1;1;1], n_supercell*0.5*SC_lattice_constant_a*[1;-1;1], 0.5*SC_lattice_constant_a*[1;1;-1]];
%% Material settings
% ------------------ settings for 'user_defined' ------------------------
% Popt.material.sphere_radius   = 0.3*[ 1 1 1 1 ];
% Popt.material.cylinder_radius = 0.15*[ 1 1 1 1 ];
% Popt.material.data_name       = 'No229_BCC_H3S'; % No227_FCC_DiamondStructure No229_BCC_H3S
% ---- settings for 'FAME_Material_Isofunction_No230_BCC_DoubleGyroid' ---
Popt.material.isofunction = @(x,y,z,a1,a2,a3) FAME_Material_Isofunction_No230_BCC_DoubleGyroid( x,y,z,a1,a2,a3,Popt.lattice.lattice_constant.a );
Popt.material.isovalue    = [1.1, 1.1];
% ----------- settings for 'FAME_Material_Isofunction_test' --------------
% Popt.material.isofunction = @(x,y,z,a1,a2,a3) FAME_Material_Isofunction_test( x,y,z,a1,a2,a3,SC_lattice_constant_a );
% Popt.material.isovalue    = [1.1, 1.1];
...
switch Popt.material.material_type
    case 'isotropic'
        ...
        Popt.material.ele_permitt_in    = 16;
        Popt.material.ele_permitt_out   = 1;
        Popt.material.mag_permeab_in    = 1;
