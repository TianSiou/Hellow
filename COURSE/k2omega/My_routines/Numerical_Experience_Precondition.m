function Numerical_Experience_Precondition(C, C_1, C_2, C_3, K_tilde, K_1_tilde, K_2_tilde, K_3_tilde, B, Lambdas, freq, N, Par_mesh, Par_lattice, FAME_option)
...
% shift value nu_0
    ...
    for i = 1:length(theta)
        ...
        Info.shift_palindromic =  exp(1i*theta(i)); % nu_0
        ...
        Info.linear_system.alpha = a_eps;
