function vec_y = FAME_Matrix_Vector_Production_PML_invM_General(vec_x, freq, Avg_B_ele_tilde, Avg_B_mag_tilde, Normal_factor, Nx, Ny, Nz, N, Sigma_sqrt, Pi_Q, Pi_Qs, Pi_P, Pi_Ps, D_kx, D_ky, D_kz)
