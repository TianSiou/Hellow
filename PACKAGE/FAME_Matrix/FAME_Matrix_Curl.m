function [ C , Cs, C_1, C_2, C_3, C_x, C_y, C_z ] = FAME_Matrix_Curl( wave_vec, grid_nums, edge_lens, mesh_lens, bd_conds, lattice_type, lattice_vec_a, lattice_constant, pml_grid_numbers )
