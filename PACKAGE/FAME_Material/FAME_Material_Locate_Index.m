function [ ele_x_idx, ele_y_idx, ele_z_idx, mag_x_idx, mag_y_idx, mag_z_idx, org_idx ] = FAME_Material_Locate_Index( Par_mesh, Par_lattice, Par_material )
...
% Output: the inside-material indices for Yee's grid, corresponding to these input.
    ...
    [ ele_x_idx ] = FAME_Material_Locate( Electric_x_point_set, Par_lattice.lattice_vec_a, Par_lattice.Omega, Par_lattice.lattice_constant.Permutation, Par_material.material_handle, Par_material.periodic_judge );
    [ ele_y_idx ] = FAME_Material_Locate( Electric_y_point_set, Par_lattice.lattice_vec_a, Par_lattice.Omega, Par_lattice.lattice_constant.Permutation, Par_material.material_handle, Par_material.periodic_judge );
    [ ele_z_idx ] = FAME_Material_Locate( Electric_z_point_set, Par_lattice.lattice_vec_a, Par_lattice.Omega, Par_lattice.lattice_constant.Permutation, Par_material.material_handle, Par_material.periodic_judge );
    
    if strcmp(Par_material,'biisotropic') || strcmp(Par_material,'bianisotropic')
    [ mag_x_idx ] = FAME_Material_Locate( Magnetic_x_point_set, Par_lattice.lattice_vec_a, Par_lattice.Omega, Par_lattice.lattice_constant.Permutation, Par_material.material_handle, Par_material.periodic_judge );
    [ mag_y_idx ] = FAME_Material_Locate( Magnetic_y_point_set, Par_lattice.lattice_vec_a, Par_lattice.Omega, Par_lattice.lattice_constant.Permutation, Par_material.material_handle, Par_material.periodic_judge );
    [ mag_z_idx ] = FAME_Material_Locate( Magnetic_z_point_set, Par_lattice.lattice_vec_a, Par_lattice.Omega, Par_lattice.lattice_constant.Permutation, Par_material.material_handle, Par_material.periodic_judge );
    else
    [ mag_x_idx ] = [];
    [ mag_y_idx ] = [];
    [ mag_z_idx ] = [];
    end
    [  org_idx, reshaped_point_set  ] = FAME_Material_Locate( Origin_point_set, Par_lattice.lattice_vec_a, Par_lattice.Omega, Par_lattice.lattice_constant.Permutation, Par_material.material_handle, Par_material.periodic_judge );
...
function [ point_set_idx, reshaped_point_set ] = FAME_Material_Locate( point_set, lattice_vec_a, Omega, Permutation, material_handle, periodic_judge )
