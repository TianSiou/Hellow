function material = No191_Hexagonal_test_bianiso(sphere_radius, cylinder_radius)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
material.a0 = 6.5*10^8;
material.az = 0.69*material.a0;
material.hr = (2.11*10^8)/material.az;
...
material.parameters{1}.cylinder_top_centers       = [   .5, .5, .5-material.hr/2
                                                        .5, .5, .5-material.hr/2];
material.parameters{1}.cylinder_bot_centers       = [   .5, .5, .5+material.hr/4;
                                                        .5, .5, .5+material.hr/2];    
...
%                                                         0, 1, 1;
%                                                         1, 1, 1];
% material.parameters{1}.cylinder_bot_centers       = [   0, 0, (material.hr/2)*0.5;
%                                                         1, 0, (material.hr/2)*0.5;
%                                                         0, 1, (material.hr/2)*0.5;
%                                                         1, 1, (material.hr/2)*0.5;
%                                                         0, 0, (material.hr/2);
%                                                         1, 0, (material.hr/2);
%                                                         0, 1, (material.hr/2);
%                                                         1, 1, (material.hr/2); 
...
% material.parameters{1}.cylinder_radius(5:8)   = 0.75*cylinder_radius(1);
material.parameters{1}.cylinder_radius        = [ cylinder_radius(1), 0.75*cylinder_radius(1) ]; 
%% Collect color map
