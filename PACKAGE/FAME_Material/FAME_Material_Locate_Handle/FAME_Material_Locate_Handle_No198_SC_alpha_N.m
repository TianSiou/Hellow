function idx = FAME_Material_Locate_Handle_No198_SC_alpha_N( X, Y, Z, a1, a2, a3, sphere_radius)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    sphere_center_N_5  =       x2*a1  +       x2*a2 +        x2*a3;
    sphere_center_N_6  = (1/2-x2)*a1  +   (1-x2)*a2 +  (1/2+x2)*a3;
    sphere_center_N_7  =   (1-x2)*a1  + (1/2+x2)*a2 +  (1/2-x2)*a3;
    sphere_center_N_8  = (1/2+x2)*a1  + (1/2-x2)*a2 +    (1-x2)*a3;
