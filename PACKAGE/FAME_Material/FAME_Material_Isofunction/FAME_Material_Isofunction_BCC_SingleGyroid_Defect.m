function G = FAME_Material_Isofunction_BCC_SingleGyroid_Defect( x,y,z,a1,a2,a3,lattice_constant_a, num_airsphere )
...
%% One air Sphere
% Center1   = (0.45) * a1 + (0.45) * a2 + (0.45) * a3;
Center1   = [0.125,0.125,0.125]' + 2/5 * (a1 + a2 + a3);
