function vec_y = FAME_Matrix_Vector_Production_Biisotropic_Ar_Simple_fem2(vec_x, B, Nx, Ny, Nz, N, Pi_Qr, Pi_Pr, Pi_Qrs, Pi_Prs, D_k, D_ks, Lambda_fem)

    vec_x_ele = vec_x(1:end/2);
    vec_x_mag = vec_x(end/2+1:end);

    vec_y_ele = FAME_Matrix_Vector_Production_Pr_Simple_fem(vec_x_ele, Nx, Ny, Nz, N, Pi_Pr, Pi_Prs, D_k, D_ks, Lambda_fem, 'normal');
    ...
    vec_y_ele = FAME_Matrix_Vector_Production_Pr_Simple_fem(temp_vec_y_ele, Nx, Ny, Nz, N, Pi_Pr, Pi_Prs, D_k, D_ks, Lambda_fem, 'hermitian');
